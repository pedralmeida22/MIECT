insert into g6stocks.tipo_fornecedor(
	codigo, designacao
) 
values
	(101,'Carnes'),
...
insert into g6stocks.fornecedor(
...
select * from g6stocks.produto;



insert into g6stocks.encomenda(
