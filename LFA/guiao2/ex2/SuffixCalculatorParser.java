...
public class SuffixCalculatorParser extends Parser {
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__4) | (1L << Number) | (1L << NEWLINE))) != 0)) {
				{
				{
				setState(6);
				stat();
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(32);
						((ExprContext)_localctx).rigth = expr(0);
						setState(33);
						...
						if ( !(_la==T__0 || _la==T__1) ) {
						 ...
						 if((((ExprContext)_localctx).op!=null?((ExprContext)_localctx).op.getText():null).equals("*"))
						                                                              ((ExprContext)_localctx).v =  ((ExprContext)_localctx).left.v * ((ExprContext)_localctx).rigth.v;
						                                                         else ((ExprContext)_localctx).v =  ((ExprContext)_localctx).left.v / ((ExprContext)_localctx).rigth.v; 
						}
						break;
					case 2:
						{
	...
	public static final String _serializedATN =
		...
		"\2 -\3\2\2\2!\"\f\6\2\2\"#\5\6\4\2#$\t\2\2\2$%\b\4\1\2%,\3\2\2\2&\'\f"+
		"\5\2\2\'(\5\6\4\2()\t\3\2\2)*\b\4\1\2*,\3\2\2\2+!\3\2\2\2+&\3\2\2\2,/"+
