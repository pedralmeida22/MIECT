...
-- Equation(s):
-- \s_count[2]~38_combout\ = (s_count(2) & (\s_count[1]~35\ $ (GND))) # (!s_count(2) & (!\s_count[1]~35\ & VCC))
-- \s_count[2]~39\ = CARRY((s_count(2) & !\s_count[1]~35\))
...
-- Equation(s):
-- \s_count[0]~37_combout\ = (\reset~input_o\) # ((\enable~input_o\ & ((\start~input_o\) # (!\Equal0~10_combout\))))
...
PORT MAP (
	...
	sclr => \s_count[0]~36_combout\,
	ena => \s_count[0]~37_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => s_count(2));
...
-- Equation(s):
-- \Equal0~10_combout\ = (\Equal0~9_combout\ & (!s_count(0) & !s_count(2)))
...
-- Equation(s):
-- \s_count[0]~36_combout\ = (\reset~input_o\) # ((\Equal0~10_combout\ & (!\start~input_o\)) # (!\Equal0~10_combout\ & ((\Equal1~0_combout\))))
...
-- Equation(s):
-- \Equal1~0_combout\ = (\Equal0~9_combout\ & (s_count(0) & s_count(2)))
...
-- Equation(s):
-- \timerOut~0_combout\ = (!\reset~input_o\ & ((\enable~input_o\ & ((!\Equal1~0_combout\))) # (!\enable~input_o\ & (\timerOut~reg0_q\))))
