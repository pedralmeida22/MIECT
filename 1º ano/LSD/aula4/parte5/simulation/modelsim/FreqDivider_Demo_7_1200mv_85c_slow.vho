...
SIGNAL \fd_d|clkOut~clkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
...
SIGNAL \fd_d|clkOut~feeder_combout\ : std_logic;
SIGNAL \fd_d|clkOut~q\ : std_logic;
SIGNAL \fd_d|clkOut~clkctrl_outclk\ : std_logic;
SIGNAL \SW[1]~input_o\ : std_logic;
SIGNAL \SW[0]~input_o\ : std_logic;
SIGNAL \counter|s_cntValue~11_combout\ : std_logic;
SIGNAL \counter|s_cntValue[1]~4_cout\ : std_logic;
SIGNAL \counter|s_cntValue[1]~5_combout\ : std_logic;
SIGNAL \counter|s_cntValue[1]~6\ : std_logic;
SIGNAL \counter|s_cntValue[2]~7_combout\ : std_logic;
SIGNAL \counter|s_cntValue[2]~8\ : std_logic;
SIGNAL \counter|s_cntValue[3]~9_combout\ : std_logic;
...
SIGNAL \counter|s_cntValue\ : std_logic_vector(3 DOWNTO 0);
...
\fd_d|clkOut~clkctrl_INCLK_bus\ <= (vcc & vcc & vcc & \fd_d|clkOut~q\);
...
-- pragma translate_on
PORT MAP (
	i => \decoder|decOut_n[0]~0_combout\,
	devoe => ww_devoe,
	o => \HEX0[0]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \decoder|decOut_n[1]~1_combout\,
	devoe => ww_devoe,
	o => \HEX0[1]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \decoder|decOut_n[2]~2_combout\,
	devoe => ww_devoe,
	o => \HEX0[2]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \decoder|decOut_n[3]~3_combout\,
	devoe => ww_devoe,
	o => \HEX0[3]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \decoder|decOut_n[4]~4_combout\,
	devoe => ww_devoe,
	o => \HEX0[4]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \decoder|decOut_n[5]~5_combout\,
	devoe => ww_devoe,
	o => \HEX0[5]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \decoder|decOut_n[6]~6_combout\,
	devoe => ww_devoe,
	o => \HEX0[6]~output_o\);
...
-- Equation(s):
-- \fd_d|s_counter~11_combout\ = (\fd_d|Add2~12_combout\ & !\fd_d|Equal0~11_combout\)
...
-- pragma translate_on
PORT MAP (
	dataa => \fd_d|Add2~12_combout\,
	datad => \fd_d|Equal0~11_combout\,
...
-- Equation(s):
-- \fd_d|Equal0~5_combout\ = (!\fd_d|s_counter\(7) & (!\fd_d|s_counter\(6) & (\fd_d|s_counter\(3) & \fd_d|s_counter\(4))))
...
-- pragma translate_on
PORT MAP (
	dataa => \fd_d|s_counter\(7),
	datab => \fd_d|s_counter\(6),
	datac => \fd_d|s_counter\(3),
	datad => \fd_d|s_counter\(4),
...
-- Equation(s):
-- \fd_d|s_counter~2_combout\ = (!\fd_d|Equal0~11_combout\ & \fd_d|Add2~32_combout\)
...
-- Equation(s):
-- \fd_d|s_counter~7_combout\ = (\fd_d|Add2~36_combout\ & !\fd_d|Equal0~11_combout\)
...
-- pragma translate_on
PORT MAP (
	dataa => \fd_d|Add2~36_combout\,
	datad => \fd_d|Equal0~11_combout\,
	combout => \fd_d|s_counter~7_combout\);

-- Location: FF_X53_Y66_N27
...
-- Equation(s):
-- \fd_d|s_counter~6_combout\ = (!\fd_d|Equal0~11_combout\ & \fd_d|Add2~38_combout\)
...
-- Equation(s):
-- \fd_d|s_counter~5_combout\ = (\fd_d|Add2~40_combout\ & !\fd_d|Equal0~11_combout\)
...
-- Equation(s):
-- \fd_d|s_counter~10_combout\ = (!\fd_d|Equal0~11_combout\ & \fd_d|Add2~22_combout\)
...
-- Equation(s):
-- \fd_d|s_counter~9_combout\ = (\fd_d|Add2~24_combout\ & !\fd_d|Equal0~11_combout\)
...
-- Equation(s):
-- \fd_d|s_counter~8_combout\ = (\fd_d|Add2~26_combout\ & !\fd_d|Equal0~11_combout\)
...
-- Equation(s):
-- \fd_d|Equal0~2_combout\ = (\fd_d|s_counter\(20) & (\fd_d|s_counter\(19) & (\fd_d|s_counter\(18) & \fd_d|s_counter\(13))))
...
-- Equation(s):
-- \fd_d|s_counter~4_combout\ = (\fd_d|Add2~42_combout\ & !\fd_d|Equal0~11_combout\)
...
-- Equation(s):
-- \fd_d|s_counter~1_combout\ = (!\fd_d|Equal0~11_combout\ & \fd_d|Add2~44_combout\)
...
-- Equation(s):
-- \fd_d|s_counter~0_combout\ = (!\fd_d|Equal0~11_combout\ & \fd_d|Add2~48_combout\)
...
-- Equation(s):
-- \fd_d|Equal0~0_combout\ = (!\fd_d|s_counter\(31) & (!\fd_d|s_counter\(29) & (!\fd_d|s_counter\(30) & !\fd_d|s_counter\(28))))
...
PORT MAP (
	dataa => \fd_d|s_counter\(31),
	datab => \fd_d|s_counter\(29),
	datac => \fd_d|s_counter\(30),
...
-- Equation(s):
-- \fd_d|Equal0~1_combout\ = (\fd_d|s_counter\(21) & (!\fd_d|s_counter\(25) & (!\fd_d|s_counter\(26) & !\fd_d|s_counter\(27))))
...
-- Equation(s):
-- \fd_d|Equal0~4_combout\ = (\fd_d|Equal0~2_combout\ & (\fd_d|Equal0~0_combout\ & (\fd_d|Equal0~1_combout\ & \fd_d|Equal0~3_combout\)))
...
PORT MAP (
	...
	datab => \fd_d|Equal0~0_combout\,
	datac => \fd_d|Equal0~1_combout\,
...
-- Equation(s):
-- \fd_d|Equal0~6_combout\ = (\fd_d|s_counter\(2) & (\fd_d|s_counter\(0) & \fd_d|s_counter\(1)))
...
PORT MAP (
	...
	datad => \fd_d|s_counter\(1),
	combout => \fd_d|Equal0~6_combout\);

-- Location: LCCOMB_X55_Y66_N22
\fd_d|Equal0~11\ : cycloneive_lcell_comb
-- Equation(s):
-- \fd_d|Equal0~11_combout\ = (\fd_d|Equal0~5_combout\ & (\fd_d|Equal0~10_combout\ & (\fd_d|Equal0~4_combout\ & \fd_d|Equal0~6_combout\)))
...
PORT MAP (
	...
	datac => \fd_d|Equal0~4_combout\,
	datad => \fd_d|Equal0~6_combout\,
...
-- Equation(s):
-- \fd_d|s_counter~3_combout\ = (!\fd_d|Equal0~11_combout\ & \fd_d|Add2~28_combout\)
...
-- Equation(s):
-- \fd_d|Equal0~9_combout\ = (!\fd_d|s_counter\(15) & (\fd_d|s_counter\(14) & (!\fd_d|s_counter\(10) & \fd_d|s_counter\(16))))
...
PORT MAP (
	dataa => \fd_d|s_counter\(15),
	datab => \fd_d|s_counter\(14),
	datac => \fd_d|s_counter\(10),
	datad => \fd_d|s_counter\(16),
	combout => \fd_d|Equal0~9_combout\);

-- Location: LCCOMB_X55_Y66_N28
\fd_d|Equal0~8\ : cycloneive_lcell_comb
-- Equation(s):
-- \fd_d|Equal0~8_combout\ = (!\fd_d|s_counter\(23) & (\fd_d|s_counter\(24) & (\fd_d|s_counter\(22) & !\fd_d|s_counter\(17))))
...
-- pragma translate_on
PORT MAP (
	dataa => \fd_d|s_counter\(23),
	datab => \fd_d|s_counter\(24),
	datac => \fd_d|s_counter\(22),
...
-- Equation(s):
-- \fd_d|Equal0~10_combout\ = (\fd_d|s_counter\(5) & (\fd_d|Equal0~9_combout\ & \fd_d|Equal0~8_combout\))
...
-- Equation(s):
-- \fd_d|clkOut~0_combout\ = (\fd_d|s_counter\(17) & (!\fd_d|s_counter\(24) & (!\fd_d|s_counter\(22) & \fd_d|s_counter\(23))))
...
-- pragma translate_on
PORT MAP (
	dataa => \fd_d|s_counter\(17),
	datab => \fd_d|s_counter\(24),
	datac => \fd_d|s_counter\(22),
	datad => \fd_d|s_counter\(23),
	combout => \fd_d|clkOut~0_combout\);

-- Location: LCCOMB_X55_Y66_N24
\fd_d|clkOut~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \fd_d|clkOut~1_combout\ = (!\fd_d|s_counter\(16) & (!\fd_d|s_counter\(14) & (\fd_d|s_counter\(10) & \fd_d|s_counter\(15))))
...
-- pragma translate_on
PORT MAP (
	dataa => \fd_d|s_counter\(16),
	datab => \fd_d|s_counter\(14),
	datac => \fd_d|s_counter\(10),
	datad => \fd_d|s_counter\(15),
...
-- Equation(s):
-- \fd_d|Equal0~7_combout\ = (\fd_d|Equal0~6_combout\ & (\fd_d|Equal0~5_combout\ & \fd_d|Equal0~4_combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \fd_d|Equal0~6_combout\,
	datac => \fd_d|Equal0~5_combout\,
...
-- Equation(s):
-- \fd_d|clkOut~3_combout\ = (\fd_d|Equal0~7_combout\ & (!\fd_d|Equal0~10_combout\ & ((\fd_d|clkOut~q\) # (\fd_d|clkOut~2_combout\)))) # (!\fd_d|Equal0~7_combout\ & (\fd_d|clkOut~q\))
...
PORT MAP (
	dataa => \fd_d|clkOut~q\,
	datab => \fd_d|Equal0~10_combout\,
	datac => \fd_d|clkOut~2_combout\,
	datad => \fd_d|Equal0~7_combout\,
	combout => \fd_d|clkOut~3_combout\);

-- Location: LCCOMB_X55_Y66_N16
\fd_d|clkOut~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \fd_d|clkOut~feeder_combout\ = \fd_d|clkOut~3_combout\
...
-- pragma translate_on
PORT MAP (
	datac => \fd_d|clkOut~3_combout\,
	combout => \fd_d|clkOut~feeder_combout\);
...
PORT MAP (
	clk => \CLOCK_50~inputclkctrl_outclk\,
	d => \fd_d|clkOut~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \fd_d|clkOut~q\);

-- Location: CLKCTRL_G14
\fd_d|clkOut~clkctrl\ : cycloneive_clkctrl
-- pragma translate_off
GENERIC MAP (
	clock_type => "global clock",
	ena_register_mode => "none")
-- pragma translate_on
PORT MAP (
	inclk => \fd_d|clkOut~clkctrl_INCLK_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	outclk => \fd_d|clkOut~clkctrl_outclk\);
...
\counter|s_cntValue~11\ : cycloneive_lcell_comb
-- Equation(s):
-- \counter|s_cntValue~11_combout\ = (!\counter|s_cntValue\(0) & !\SW[0]~input_o\)
...
-- pragma translate_on
PORT MAP (
	datac => \counter|s_cntValue\(0),
	datad => \SW[0]~input_o\,
	combout => \counter|s_cntValue~11_combout\);

-- Location: FF_X114_Y65_N13
\counter|s_cntValue[0]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
-- pragma translate_on
PORT MAP (
	clk => \fd_d|clkOut~clkctrl_outclk\,
	d => \counter|s_cntValue~11_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \counter|s_cntValue\(0));

-- Location: LCCOMB_X114_Y65_N18
\counter|s_cntValue[1]~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \counter|s_cntValue[1]~4_cout\ = CARRY(\counter|s_cntValue\(0))
...
-- pragma translate_on
PORT MAP (
	dataa => \counter|s_cntValue\(0),
	datad => VCC,
	cout => \counter|s_cntValue[1]~4_cout\);

-- Location: LCCOMB_X114_Y65_N20
\counter|s_cntValue[1]~5\ : cycloneive_lcell_comb
-- Equation(s):
-- \counter|s_cntValue[1]~5_combout\ = (\SW[1]~input_o\ & ((\counter|s_cntValue\(1) & (!\counter|s_cntValue[1]~4_cout\)) # (!\counter|s_cntValue\(1) & ((\counter|s_cntValue[1]~4_cout\) # (GND))))) # (!\SW[1]~input_o\ & ((\counter|s_cntValue\(1) & 
-- (\counter|s_cntValue[1]~4_cout\ & VCC)) # (!\counter|s_cntValue\(1) & (!\counter|s_cntValue[1]~4_cout\))))
-- \counter|s_cntValue[1]~6\ = CARRY((\SW[1]~input_o\ & ((!\counter|s_cntValue[1]~4_cout\) # (!\counter|s_cntValue\(1)))) # (!\SW[1]~input_o\ & (!\counter|s_cntValue\(1) & !\counter|s_cntValue[1]~4_cout\)))
...
PORT MAP (
	dataa => \SW[1]~input_o\,
	datab => \counter|s_cntValue\(1),
	datad => VCC,
	cin => \counter|s_cntValue[1]~4_cout\,
	combout => \counter|s_cntValue[1]~5_combout\,
	cout => \counter|s_cntValue[1]~6\);

-- Location: FF_X114_Y65_N21
\counter|s_cntValue[1]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \fd_d|clkOut~clkctrl_outclk\,
	d => \counter|s_cntValue[1]~5_combout\,
	sclr => \SW[0]~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \counter|s_cntValue\(1));

-- Location: LCCOMB_X114_Y65_N22
\counter|s_cntValue[2]~7\ : cycloneive_lcell_comb
-- Equation(s):
-- \counter|s_cntValue[2]~7_combout\ = ((\counter|s_cntValue\(2) $ (\SW[1]~input_o\ $ (\counter|s_cntValue[1]~6\)))) # (GND)
-- \counter|s_cntValue[2]~8\ = CARRY((\counter|s_cntValue\(2) & ((!\counter|s_cntValue[1]~6\) # (!\SW[1]~input_o\))) # (!\counter|s_cntValue\(2) & (!\SW[1]~input_o\ & !\counter|s_cntValue[1]~6\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \counter|s_cntValue\(2),
	datab => \SW[1]~input_o\,
	datad => VCC,
	cin => \counter|s_cntValue[1]~6\,
	combout => \counter|s_cntValue[2]~7_combout\,
	cout => \counter|s_cntValue[2]~8\);

-- Location: FF_X114_Y65_N23
\counter|s_cntValue[2]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \fd_d|clkOut~clkctrl_outclk\,
	d => \counter|s_cntValue[2]~7_combout\,
	sclr => \SW[0]~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \counter|s_cntValue\(2));

-- Location: LCCOMB_X114_Y65_N24
\counter|s_cntValue[3]~9\ : cycloneive_lcell_comb
-- Equation(s):
-- \counter|s_cntValue[3]~9_combout\ = \SW[1]~input_o\ $ (\counter|s_cntValue[2]~8\ $ (!\counter|s_cntValue\(3)))
...
PORT MAP (
	datab => \SW[1]~input_o\,
	datad => \counter|s_cntValue\(3),
	cin => \counter|s_cntValue[2]~8\,
	combout => \counter|s_cntValue[3]~9_combout\);

-- Location: FF_X114_Y65_N25
\counter|s_cntValue[3]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \fd_d|clkOut~clkctrl_outclk\,
	d => \counter|s_cntValue[3]~9_combout\,
	sclr => \SW[0]~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \counter|s_cntValue\(3));

-- Location: LCCOMB_X114_Y65_N26
\decoder|decOut_n[0]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \decoder|decOut_n[0]~0_combout\ = (\counter|s_cntValue\(2) & (!\counter|s_cntValue\(1) & (\counter|s_cntValue\(3) $ (!\counter|s_cntValue\(0))))) # (!\counter|s_cntValue\(2) & (\counter|s_cntValue\(0) & (\counter|s_cntValue\(3) $ 
-- (!\counter|s_cntValue\(1)))))
...
PORT MAP (
	dataa => \counter|s_cntValue\(2),
	datab => \counter|s_cntValue\(3),
	datac => \counter|s_cntValue\(0),
	datad => \counter|s_cntValue\(1),
	combout => \decoder|decOut_n[0]~0_combout\);

-- Location: LCCOMB_X114_Y65_N8
\decoder|decOut_n[1]~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \decoder|decOut_n[1]~1_combout\ = (\counter|s_cntValue\(3) & ((\counter|s_cntValue\(0) & ((\counter|s_cntValue\(1)))) # (!\counter|s_cntValue\(0) & (\counter|s_cntValue\(2))))) # (!\counter|s_cntValue\(3) & (\counter|s_cntValue\(2) & 
-- (\counter|s_cntValue\(0) $ (\counter|s_cntValue\(1)))))
...
-- Equation(s):
-- \decoder|decOut_n[2]~2_combout\ = (\counter|s_cntValue\(2) & (\counter|s_cntValue\(3) & ((\counter|s_cntValue\(1)) # (!\counter|s_cntValue\(0))))) # (!\counter|s_cntValue\(2) & (!\counter|s_cntValue\(3) & (!\counter|s_cntValue\(0) & 
-- \counter|s_cntValue\(1))))
...
-- Equation(s):
-- \decoder|decOut_n[3]~3_combout\ = (\counter|s_cntValue\(1) & ((\counter|s_cntValue\(2) & ((\counter|s_cntValue\(0)))) # (!\counter|s_cntValue\(2) & (\counter|s_cntValue\(3) & !\counter|s_cntValue\(0))))) # (!\counter|s_cntValue\(1) & 
-- (!\counter|s_cntValue\(3) & (\counter|s_cntValue\(2) $ (\counter|s_cntValue\(0)))))
...
-- Equation(s):
-- \decoder|decOut_n[4]~4_combout\ = (\counter|s_cntValue\(1) & (((!\counter|s_cntValue\(3) & \counter|s_cntValue\(0))))) # (!\counter|s_cntValue\(1) & ((\counter|s_cntValue\(2) & (!\counter|s_cntValue\(3))) # (!\counter|s_cntValue\(2) & 
-- ((\counter|s_cntValue\(0))))))
...
-- Equation(s):
-- \decoder|decOut_n[5]~5_combout\ = (\counter|s_cntValue\(2) & (\counter|s_cntValue\(0) & (\counter|s_cntValue\(3) $ (\counter|s_cntValue\(1))))) # (!\counter|s_cntValue\(2) & (!\counter|s_cntValue\(3) & ((\counter|s_cntValue\(0)) # 
-- (\counter|s_cntValue\(1)))))
...
-- Equation(s):
-- \decoder|decOut_n[6]~6_combout\ = (\counter|s_cntValue\(0) & (!\counter|s_cntValue\(3) & (\counter|s_cntValue\(2) $ (!\counter|s_cntValue\(1))))) # (!\counter|s_cntValue\(0) & (!\counter|s_cntValue\(1) & (\counter|s_cntValue\(2) $ 
-- (!\counter|s_cntValue\(3)))))
