...
public abstract class Motorizado extends Veiculo {
	...
	public Motorizado(int nRodas, int cil, int mv, int p, double consumo) { // para os que nao tem 4 rodas
		super(2015, Cor.CINZENTO, nRodas);
		this.cilindrada = cil;
		this.maxVel = mv;
		this.potencia = p;
		this.consumo = consumo;
	...
	public Motorizado(int cil, int mv, int p, double consumo) {
		super(2012, Cor.CINZENTO, 4);
		this.cilindrada = cil;
		this.maxVel = mv;
		this.potencia = p;
		this.consumo = consumo;
	...
	public String toString() {
		return super.toString() + " cilindrada=" + cilindrada + ", maxVel=" + maxVel + ", potencia=" + potencia + ", comb="
